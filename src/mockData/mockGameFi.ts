...
export const mockAchievements: Achievement[] = [
  {
    ...
    imageUrl: '/assets/achievements/code-warrior.png',
    isUnlocked: true,
    progress: 100,
    requiredValue: 10,
    currentValue: 12,
  ...
  },
  {
    ...
    imageUrl: '/assets/achievements/quiz-master.png',
    isUnlocked: false,
    progress: 60,
    requiredValue: 5,
    currentValue: 3,
  ...
  },
  {
    ...
    imageUrl: '/assets/achievements/consistent-learner.png',
    isUnlocked: true,
    progress: 100,
    requiredValue: 7,
    currentValue: 9,
  ...
  },
  {
    ...
    imageUrl: '/assets/achievements/algorithm-genius.png',
    isUnlocked: false,
    progress: 45,
    requiredValue: 20,
    currentValue: 9,
  ...
  },
  {
    ...
    imageUrl: '/assets/achievements/security-specialist.png',
    isUnlocked: false,
    progress: 33,
    requiredValue: 6,
    currentValue: 2,
